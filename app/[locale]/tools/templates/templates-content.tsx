                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div ref={gridRef} className="grid gap-6">
                        {templates.map((template) => (
                            <div
                                key={template.id}
                                className="p-6 rounded-xl bg-cv-elevated border border-[var(--border-subtle)] card-hover border-glow"
                            >
                                <div className="flex flex-col md:flex-row md:items-start gap-6">
                                    <div className="flex-1">
                                        <div className="flex items-center gap-3 mb-2">
                                            <h3 className="text-xl font-semibold text-[var(--text-primary)]">{template.title}</h3>
                                            <span className="px-2 py-0.5 rounded text-xs bg-accent/10 text-accent">{template.format}</span>
                                        </div>
                                        <p className="text-[var(--text-tertiary)] mb-4">{template.description}</p>
                                    ...
                                    <a
                                        ...
                                        className="flex items-center gap-2 px-6 py-3 rounded-lg bg-accent/10 text-accent font-medium hover:bg-accent/20 transition-all shrink-0"
                                    >
