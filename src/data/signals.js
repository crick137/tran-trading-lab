// 모든 시그널은 1R 기준. result: 'win' | 'loss' | 'open'
export const signals = [
  ...
  { symbol: 'AUDJPY', side: 'BUY',  tf: 'M30', entry: '100.32', tp: '100.94', sl: '99.98',  rr: 2.0, result: 'loss', date: '2025-10-11', logic: 'BOS 이후 OB 리테스트' },
