...
const styles = {
    ...
    brandName: { fontSize: 16, fontWeight: 900, color: '#3b82f6', letterSpacing: '-0.03em' },
    ...
    statusDot: {
        ...
        boxShadow: '0 0 8px rgba(16, 185, 129, 0.6), 0 0 16px rgba(52, 211, 153, 0.4), 0 0 24px rgba(16, 185, 129, 0.2)',
        animation: 'pulse 2s ease-in-out infinite',
    },
    statusText: { fontSize: 10, fontWeight: 700, color: '#10b981', letterSpacing: '0.08em', textShadow: '0 0 10px rgba(16, 185, 129, 0.5)' },
    latencyBox: {
        display: 'flex',
        alignItems: 'center',
        gap: 4,
    ...
    marketOpen: { color: '#10b981', fontWeight: 700 },
