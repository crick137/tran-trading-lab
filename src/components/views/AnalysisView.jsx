...
const styles = {
    ...
    categoryBtnActive: { background: 'linear-gradient(135deg, rgba(59,130,246,0.12) 0%, rgba(59,130,246,0.08) 100%)', borderColor: 'rgba(59, 130, 246, 0.4)', color: '#60a5fa', boxShadow: '0 0 20px rgba(59, 130, 246, 0.2)' },
    ...
    featuredBadge: { display: 'inline-flex', alignItems: 'center', gap: 'var(--space-2)', width: 'fit-content', padding: 'var(--space-1) var(--space-3)', background: 'rgba(59,130,246,0.12)', borderRadius: 'var(--radius-full)', fontSize: '0.625rem', fontWeight: '700', color: '#3b82f6', letterSpacing: '0.1em', textTransform: 'uppercase' },
    ...
    readBtn: { display: 'flex', alignItems: 'center', gap: 'var(--space-2)', width: 'fit-content', padding: 'var(--space-3) var(--space-6)', background: 'linear-gradient(135deg, #3b82f6 0%, #2563eb 100%)', border: 'none', borderRadius: 'var(--radius-lg)', fontSize: '0.875rem', fontWeight: '600', color: 'white', cursor: 'pointer', marginTop: 'auto', boxShadow: '0 4px 14px rgba(59,130,246,0.3)' },
    ...
    articleCategory: { fontSize: '0.625rem', fontWeight: '700', color: '#3b82f6', textTransform: 'uppercase', letterSpacing: '0.05em' },
    ...
    authorAvatar: { width: '24px', height: '24px', background: 'linear-gradient(135deg, #3b82f6 0%, #60a5fa 100%)', borderRadius: 'var(--radius-sm)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.6875rem', fontWeight: '700', color: '#fff' },
    ...
    hoverIndicator: { position: 'absolute', right: 'var(--space-4)', top: '50%', transform: 'translateY(-50%) translateX(10px)', opacity: 0, color: '#3b82f6' },
}
