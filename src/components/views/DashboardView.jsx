...
const styles = {
    ...
    container: { display: 'flex', flexDirection: 'column', height: '100%', background: '#020408', fontFamily: "'Inter', -apple-system, sans-serif", overflow: 'hidden' },
    heroBar: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 20px', background: 'linear-gradient(180deg, rgba(0, 210, 106, 0.04) 0%, transparent 100%)', borderBottom: '1px solid rgba(255,255,255,0.04)' },
    ...
    mainGrid: { display: 'grid', gridTemplateColumns: '280px 1fr 300px', flex: 1, gap: 1, background: 'rgba(255,255,255,0.02)', overflow: 'hidden' },
    marketPanel: { display: 'flex', flexDirection: 'column', background: '#040810', overflow: 'hidden' },
    ...
    rightPanel: { display: 'flex', flexDirection: 'column', background: '#040810', overflow: 'hidden' },
    panelHead: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 18px', background: 'rgba(0,0,0,0.3)', borderBottom: '1px solid rgba(255,255,255,0.03)' },
    headLeft: { display: 'flex', alignItems: 'center', gap: 10, fontSize: 13, fontWeight: 600, color: 'rgba(255,255,255,0.8)' },
    headIcon: { width: 28, height: 28, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(0, 210, 106, 0.1)', borderRadius: 6, color: '#00d26a' },
    countBadge: { padding: '2px 8px', background: 'rgba(0, 210, 106, 0.1)', borderRadius: 10, fontSize: 10, fontWeight: 700, color: '#00d26a' },
    ...
    marketRow: { display: 'grid', gridTemplateColumns: '1fr 80px 60px 70px', alignItems: 'center', padding: '12px 18px', borderBottom: '1px solid rgba(255,255,255,0.02)', cursor: 'pointer', transition: 'all 0.2s ease' },
    symbolCell: { display: 'flex', alignItems: 'center', gap: 10 },
    symbolDot: { width: 28, height: 28, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, rgba(0, 210, 106, 0.2), rgba(0, 180, 100, 0.1))', borderRadius: 6, fontSize: 11, fontWeight: 800, color: '#00d26a' },
    ...
    statusBar: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 24px', background: 'linear-gradient(90deg, #00d26a 0%, #00ff88 100%)', color: '#000' },
    statusLeft: { display: 'flex', alignItems: 'center', gap: 14, fontSize: 11, fontWeight: 600 },
