...
const styles = {
    ...
    refreshBtn: { width: 36, height: 36, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(59, 130, 246, 0.1)', border: '1px solid rgba(59, 130, 246, 0.3)', borderRadius: 'var(--radius-md)', color: '#60a5fa', cursor: 'pointer', transition: 'all 0.2s ease' },
    ...
    categoryPillActive: { background: 'linear-gradient(135deg, rgba(59, 130, 246, 0.2) 0%, rgba(59, 130, 246, 0.08) 100%)', borderColor: 'rgba(59, 130, 246, 0.4)', color: '#60a5fa', boxShadow: '0 0 16px rgba(59, 130, 246, 0.2)' },
    ...
    newsSource: { fontSize: '0.6875rem', fontWeight: '700', color: '#3b82f6', textTransform: 'uppercase', letterSpacing: '0.05em' },
    ...
    openIndicator: { display: 'flex', alignItems: 'center', justifyContent: 'center', width: 40, height: 40, borderRadius: 'var(--radius-md)', background: 'rgba(59,130,246,0.1)', color: '#60a5fa', flexShrink: 0 },
    // Article Reader Modal
    ...
    readerSource: { fontSize: '0.75rem', fontWeight: 700, color: '#3b82f6', textTransform: 'uppercase', letterSpacing: '0.08em' },
