    ...
    return (
        <div className={cn("relative overflow-hidden", className)}>
            ...
            <div className="pointer-events-none absolute inset-0">
                ...
                <div
                    className="absolute -inset-[100px] opacity-[0.04] animate-[aurora-drift-1_30s_ease-in-out_infinite]"
                    style={{
                        background:
                ...
                <div
                    className="absolute -inset-[100px] opacity-[0.03] animate-[aurora-drift-2_35s_ease-in-out_infinite]"
                    style={{
                        background:
                ...
                <div
                    className="absolute -inset-[100px] opacity-[0.025] animate-[aurora-drift-3_28s_ease-in-out_infinite]"
                    style={{
                        background:
