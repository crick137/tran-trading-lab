    ...
    return (
        <div className={cn("relative overflow-hidden", className)}>
            ...
            <div className="pointer-events-none absolute inset-0">
                ...
                <div
                    className="absolute -inset-[100px] opacity-[0.07] animate-[aurora-drift-1_20s_ease-in-out_infinite]"
                    style={{
                        background:
                ...
                <div
                    className="absolute -inset-[100px] opacity-[0.05] animate-[aurora-drift-2_25s_ease-in-out_infinite]"
                    style={{
                        background:
                ...
                <div
                    className="absolute -inset-[100px] opacity-[0.04] animate-[aurora-drift-3_18s_ease-in-out_infinite]"
                    style={{
                        background:
